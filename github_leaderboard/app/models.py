...
class Result(models.Model):
    ...
    score = models.IntegerField(default=self.default_score)
...
class Leaderboard(models.Model):
    ...
    start = models.DateTimeField(default=self.default_start_datetime)
    end = models.DateTimeField(default=self.default_end_datetime)
...
class Commit(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE)
    commit_count = models.IntegerField(default=self.default_commit_count)
    date_created = models.DateTimeField(auto_now_add=True)
    date_modified = models.DateTimeField(auto_now=True)
