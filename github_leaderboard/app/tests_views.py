...
class LeaderboardViewTests(TestCase):
    ...
    def test_leaderboard_refresh_view(self):
        ...
        request = self.factory.get(reverse('leaderboard_refresh', kwargs={"id":self.leaderboard.id} ) )
        request.user = self.user

        view = setup_view(views.fetch_leaderboard_commits(), request,self.leaderboard.id ) 
    ...
    def test_leaderboard_details_view(self):
        ...
        request = self.factory.get(reverse('leaderboard', kwargs={"id":self.leaderboard.id} ) )
        request.user = self.user
    ...
    def test_manage_leaderboard_participants(self):
        ...
        url = reverse('manage_leaderboard_participants', kwargs={"id":self.leaderboard.id} )
    ...
    def test_delete_leaderboard_participants(self):
        ...
        url = reverse('delete_leaderboard_participants', kwargs={"id":self.leaderboard.id, 'userid':self.user.id} )
